...
const GRAMMAR_DATA = {
  topics: [
    ...
    {
      id: 'articulos',
      title: 'Artículos en/ett',
      subtitle: 'en bil, ett hus, bilen, huset',
      icon: '📝',
      color: '#10B981',
      level: 'A',
      questions: [
        { text: '¿Cuántos géneros gramaticales tiene el sueco?', options: ['3 (masculino, femenino, neutro)','1','2 (común y neutro)','4'], correct: 2, explanation: 'El sueco tiene dos géneros: común (utrum) con "en", y neutro (neutrum) con "ett".' },
        { text: '¿Cuál es el artículo indefinido para palabras de género común?', options: ['ett','en','den','det'], correct: 1, explanation: '"En" es el artículo indefinido para en-ord. Ejemplo: "en bil" (un carro), "en flicka" (una chica).' },
        { text: '¿Cuál es el artículo indefinido para palabras de género neutro?', options: ['en','ett','det','den'], correct: 1, explanation: '"Ett" es el artículo indefinido para ett-ord. Ejemplo: "ett hus" (una casa), "ett barn" (un niño).' },
        { text: '¿Cómo se dice "la casa" en sueco? (hus = ett-ord)', options: ['huset','husen','husett','den hus'], correct: 0, explanation: 'Para ett-ord, el definido se forma agregando "-et" al final: "huset" = la casa.' },
        { text: '¿Cómo se dice "el libro"? (bok = en-ord)', options: ['boken','boket','den bok','boks'], correct: 0, explanation: 'Para en-ord, el definido se forma agregando "-en" al final: "boken" = el libro.' },
        { text: '¿Qué artículo usa "barn" (niño)?', options: ['en barn','ett barn','den barn','det barn'], correct: 1, explanation: '"Barn" es ett-ord → "ett barn". Definido: "barnet" (el niño).' },
        { text: '¿Cómo se dice "el niño"?', options: ['barnen','barnet','ett barn','barnett'], correct: 1, explanation: '"Barn" (ett-ord) + "-et" = "barnet" = el niño.' },
        { text: '¿Qué artículo usa "man" (hombre)?', options: ['ett man','en man','det man','den man'], correct: 1, explanation: '"Man" es en-ord → "en man". Definido: "mannen" (el hombre).' },
        { text: '¿Cómo se dice "la mujer"? (kvinna = en-ord)', options: ['kvinnaet','kvinnan','ett kvinna','den kvinna'], correct: 1, explanation: '"Kvinna" (en-ord) → definido: "kvinnan" = la mujer.' },
        { text: '"Jag har ___ hund." (Yo tengo un perro — hund es en-ord)', options: ['ett','den','en','det'], correct: 2, explanation: '"Hund" es en-ord → usa "en". "Jag har en hund" = Tengo un perro.' },
        { text: '¿Cómo se dice "un apartamento"? (lägenhet = en-ord)', options: ['ett lägenhet','en lägenhet','lägenheten','lägenheterna'], correct: 1, explanation: '"Lägenhet" es en-ord → "en lägenhet". Definido: "lägenheten" = el apartamento.' },
        { text: '¿Cómo se dice "el trabajo"? (arbete = ett-ord)', options: ['arbeten','ett arbete','arbetet','arbeteen'], correct: 2, explanation: '"Arbete" es ett-ord → definido: "arbetet" = el trabajo.' },
        { text: '¿Cuándo va el artículo ANTES de la palabra en sueco?', options: ['Siempre','Nunca — va al FINAL de la palabra','Solo con adjetivos','Solo en preguntas'], correct: 1, explanation: '¡Gran diferencia con el español! En sueco el artículo definido se AGREGA AL FINAL de la palabra: "bil"+"en" = "bilen".' },
        { text: '¿Cuál es la regla para saber si una palabra es "en" o "ett"?', options: ['Personas siempre "en", objetos "ett"','No hay regla fija — hay que aprenderlo','Palabras largas son "ett"','Palabras con vocal final son "ett"'], correct: 1, explanation: 'No hay una regla perfecta. ~75-80% de palabras son en-ord. ¡Hay que aprenderlo con práctica!' },
        { text: '¿Cómo se dice "un trabajo"? (arbete = ett-ord)', options: ['en arbete','ett arbete','arbetet','arbetar'], correct: 1, explanation: '"Arbete" es ett-ord → indefinido: "ett arbete" = un trabajo.' },
      ]
    },
